...
const libs =[ "places" ];
const defaultLoction = {lat:45.516, lng: -73.56 };


export default function MapScreen(props) {
    const [ googleApiKey, setGoogleApiKey ] = useState('');
    const [center, setCenter] = useState(defaultLoction);
        ...
        <div className="full-container">
           <LoadScript libraries= {libs} googleMapsApiKey={googleApiKey}>
            <GoogleMap
                ...
                mapContainerStyle= {{hieght: "100%", width: "100%"}}
                center ={center}
                zoom= {15}
                onLoad= {onLoad}
                onIdle= {onIdle}
